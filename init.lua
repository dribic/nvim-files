    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('FileType', {
        callback = function(args)
          ...
          if not (treesitter_attach(buf, language) or vim.tbl_contains(available_parsers, language)) then return end
          ...
          if not vim.tbl_contains(require('nvim-treesitter.config').get_installed 'parsers', language) then
            ...
            require('nvim-treesitter.install').install(language):await(function() treesitter_attach(buf, language) end)
          end
        end,
      })

      -- ensure basic parser are installed
      local parsers = { 'bash', 'diff', 'gitignore', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'vim', 'vimdoc' }
